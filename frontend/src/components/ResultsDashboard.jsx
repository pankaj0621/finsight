// =============================================================================
//  ResultsDashboard — All result sections
// =============================================================================
...
const dashStyles = `
  ...
  .btn-back {
    ...
    color: var(--text2); padding: 9px 16px; border-radius: var(--r-sm);
  ...
  .btn-pdf {
    ...
    color: var(--amber); padding: 9px 16px; border-radius: var(--r-sm);
  ...
  .card-lbl-dot { width: 4px; height: 4px; border-radius: 50%; flex-shrink: 0; }
  ...
  .score-card::before { background: linear-gradient(135deg, rgba(255,255,255,0.04) 0%, transparent 60%); }
  ...
  .score-num {
    ...
    color: var(--text); line-height: 1; text-align: center; position: relative; z-index: 1;
  }
  ...
  .sim-subtitle { font-size: 12px; color: var(--text3); margin-bottom: 22px; }
  ...
  .sim-slider-name { font-family: var(--font-mono); font-size: 10px; color: var(--text3); letter-spacing: 0.06em; text-transform: uppercase; }
  ...
  .chat-close {
    ...
    color: var(--text3); cursor: pointer; font-size: 16px; padding: 4px; transition: color 0.2s;
  }
  .chat-close:hover { color: var(--text); }

  .chat-msgs {
    flex: 1; overflow-y: auto; padding: 14px; display: flex;
    flex-direction: column; gap: 10px; max-height: 270px;
  }

  .chat-msg { padding: 10px 13px; border-radius: 10px; font-size: 12px; line-height: 1.6; max-width: 88%; }
  .chat-msg.user {
    background: rgba(245,158,11,0.08); border: 1px solid rgba(245,158,11,0.15);
    color: var(--text); align-self: flex-end; font-family: var(--font-mono); font-size: 11px;
  }
  ...
  .chat-msg.loading { opacity: 0.5; font-style: italic; font-family: var(--font-mono); font-size: 11px; }
  ...
  .chat-qbtn {
    ...
    border-radius: 20px; font-family: var(--font-mono); font-size: 10px; color: var(--text3);
    cursor: pointer; transition: all 0.2s;
  }
  ...
  .chat-input {
    ...
    color: var(--text); padding: 9px 12px; border-radius: var(--r-xs);
    ...
    <>
      ...
      <div className="results-wrap">
        ...
        <div className="bento3">
          ...
          {/* Altman Z card */}
          <div className="card altman-hero-card">
            ...
            <div className="altman-zone" style={{background:result.altman.zoneColor+"20",color:result.altman.zoneColor}}>{result.altman.zone}</div>
            <div className="altman-spectrum" style={{marginTop:20}}>
          ...
          {/* Investment card */}
          <div className="card invest-hero-card">
        ...
        <div className="bento3">
          ...
          <div className="card">
            ...
            <p style={{fontSize:11,color:"var(--text3)",marginBottom:14,lineHeight:1.5}}>Score = {result.totalScore}/100. Factor impact vs baseline of 50pts.</p>
        ...
        <div className="bento2">
          ...
          <div className="card">
            ...
            <div style={{fontSize:11,color:"var(--text3)",marginBottom:14}}>vs {result.industry||form.industry} averages</div>
